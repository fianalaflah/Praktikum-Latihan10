...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        ...
        const val EXTRA_TELEPONE = "com.example.praktikummodul10.EXTRA_TELEPONE"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            ...
            edit_text_phone.setText(intent.getStringExtra(EXTRA_TELEPONE))
    ...
    private fun saveNote() {
        ...
        val data = Intent().apply {
            ...
            putExtra(EXTRA_TELEPONE, edit_text_phone.text.toString())
